const dict = {
    en: {
        ...
        feedback_paste_hint: "…or paste an image with Ctrl+V / ⌘+V",
        feedback_paste_attached: "✓ Image attached (paste again to replace)",
        feedback_paste_invalid: "Only image files can be pasted",
    ...
    th: {
        ...
        feedback_paste_hint: "…หรือวางรูปด้วย Ctrl+V / ⌘+V",
        feedback_paste_attached: "✓ แนบรูปแล้ว (วางอีกครั้งเพื่อเปลี่ยน)",
        feedback_paste_invalid: "วางได้เฉพาะไฟล์รูปเท่านั้น",
