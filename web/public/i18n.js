const dict = {
    en: {
        ...
        filter_all: "All",
        rrg_legend: "X = RS-Ratio (Current strength vs Market) • Y = RS-Momentum (Momentum of strength) • Green = Leading • Blue = Improving • Yellow = Weakening • Red = Lagging • Large dot = latest week • Click/tap a tail or a heatmap row to spotlight one theme; click empty space to clear",
        ...
        breadth_note: "% Above 20DMA = share of theme members above their 20-day moving average (green ≥50% • yellow 30–50% • red <30%). Dollar Vol Ratio = 5-day vs 20-day average dollar volume — above 1.00x means activity is picking up, below 1.00x means it's fading.",
    ...
    th: {
        ...
        filter_sector: "Sector ETF",
        filter_all: "ทั้งหมด",
        rrg_legend: "แกน X = RS-Ratio (แรงเทียบตลาดปัจจุบัน) • แกน Y = RS-Momentum (โมเมนตัมของแรงนั้น) • เขียว Leading = แข็งและยังแรงขึ้น • ฟ้า Improving = ยังอ่อนแต่กำลังฟื้น • เหลือง Weakening = ยังแข็งแต่แผ่ว • แดง Lagging = อ่อนและยังแย่ลง • จุดใหญ่คือสัปดาห์ล่าสุด • คลิก/แตะเส้นหรือแถวใน Heatmap เพื่อไฮไลต์ธีมเดียว คลิกพื้นที่ว่างเพื่อล้าง",
        ...
        breadth_note: "% เหนือ 20DMA = สัดส่วนสมาชิกของธีมที่ยืนเหนือเส้นค่าเฉลี่ย 20 วัน (เขียว ≥50% • เหลือง 30–50% • แดง <30%) • Dollar Vol Ratio = มูลค่าซื้อขายเฉลี่ย 5 วันเทียบ 20 วัน — เกิน 1.00x คือเงินเริ่มไหลเข้า ต่ำกว่า 1.00x คือความสนใจแผ่วลง",
