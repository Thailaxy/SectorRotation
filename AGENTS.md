...
Andrej Karpathy's observations on LLM coding pitfalls. Merge with
...
> Adapted for ZCode. Cross-tool convention — Cursor, Aider, and other agents
> also read `AGENTS.md` as project context.
